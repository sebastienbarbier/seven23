...
// Todo: replace localStorage item Viewer with redux
class Viewer extends Component {
  ...
  _processData = (begin = this.state.dateBegin.toDate(), end = this.state.dateEnd.toDate()) => {
    ...
    dispatch(StatisticsActions.viewer(begin, end)).then((result) => {
...
export default connect(mapStateToProps)(withTheme()(withStyles(styles)(Viewer)));