...
export const RECEIPTS_SEND_SUCCESS = "RECEIPTS_SEND_SUCCESS";
export const RECEIPTS_REMOVE_SUCCESS= "RECEIPTS_REMOVE_SUCCESS";
export const SINGLE_RECEIPT_FETCH="SINGLE_RECEIPT_FETCH";
export const SINGLE_RECEIPT_FETCH_FAILURE ="SINGLE_RECEIPT_FETCH_FAILURE"

export const LAST_ACTION="LAST_ACTION"
export const CURRENT_REMINDER_DATE="CURRENT_REMINDER_DATE"
export const UPDATE_NOTIFICTION_STATUS="UPDATE_NOTIFICTION_STATUS"
