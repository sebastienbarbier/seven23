...
export const DB_VERSION = 3; // Cannot rollback after creation

export const ATTACHMENT_DELETE_REQUEST   = 'ATTACHMENT_DELETE_REQUEST';

export const CATEGORIES_INIT_REQUEST     = 'CATEGORIES_INIT_REQUEST';
...
export const CHANGES_INIT_REQUEST        = 'CHANGES_INIT_REQUEST';
...
export const TRANSACTIONS_INIT_REQUEST   = 'TRANSACTIONS_INIT_REQUEST';
...
export const ACCOUNTS_INIT_REQUEST       = 'ACCOUNTS_INIT_REQUEST';
...
export const CURRENCIES_INIT_REQUEST     = 'CURRENCIES_INIT_REQUEST';
